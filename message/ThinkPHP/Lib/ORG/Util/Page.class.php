...
class Page extends Think {
    ...
    protected $rollPage   ;
	// 分页显示定制
    protected $config  =	array('header'=>'Records','prev'=>'Previous','next'=>'Next','first'=>'First','last'=>'Last','theme'=>' %totalRow% %header%, Current page:%nowPage%, Total pages:%totalPage%, %upPage% %downPage% %first%  %prePage%  %linkPage%  %nextPage% %end%');
     ...
     * @param mixed $parameter  分页跳转的参数
     +----------------------------------------------------------
     */
    public function __construct($totalRows,$listRows='',$parameter='') {
        $this->totalRows = $totalRows;
        //对$this->parameter变量进行处理
    ...
    public function show() {
        ...
        $params = array_merge($params, $this->parameter);
